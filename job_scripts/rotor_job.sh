...
ARGS=(
    ...
    -s 0.16
    -w 0.15
    -f x,y,z,rho,h,Bx,By,Bz,alpha_B,divB
    -o "$OUT_DIR/dump.h5"
    -op "$OUT_DIR/profile"
)
...
python "$REPO_ROOT/scripts/plot_slice.py" "$OUT_DIR/dump.h5" --all --field Pmag --cmap jet --contours 30
